...
@SpringJUnitConfig
@ContextConfiguration(classes = TestBeanQualifiersInSubContextWrongFieldName.BeanConfigurations.class)
public class TestBeanQualifiersInSubContextWrongFieldName {
